package org.opendatakraken.cli.commands;
...
public class JSONCommands implements CommandMarker {
	...
	@CliAvailabilityIndicator({ "hw simple", "json-extract", "json-generator" })
	...
	public String hello(@CliOption(key = { "message" }, mandatory = true, help = "The hello world message") final String message,
