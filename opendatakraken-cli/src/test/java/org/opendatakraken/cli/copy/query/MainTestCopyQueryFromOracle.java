...
public class MainTestCopyQueryFromOracle {
	
	private String[] sourceArgs = new String[4];
	private String[] targetArgs = new String[4];
	
	private void initSource() {
		sourceArgs[0] = "localhost_oracle_dwhdev_test";
		sourceArgs[1] = "";
		sourceArgs[2] = "select * from tab_test";
	}
	...
	public void testDB2() {
		...
		//
		MainTestCopyQueryHelper.initSource(sourceArgs);
		MainTestCopyQueryHelper.initTarget(targetArgs);
		// Perform test
		try {
			MainTestCopyQueryHelper.execute();
		}
		catch (Exception e) {
			fail("Exception: \n" + e);
		}
